...
<body class="bg-putih-200">
    <div class="flex items-center justify-center sm:p-10 p-5 lg:px-10 bg-gray-100">
        <div
            class="min-h-screen max-w-5xl mx-auto place-content-center justify-center justify-items-center grid md:grid-cols-2 lg:grid-cols-3 gap-x-14 gap-y-5">
            <!-- vote.blade.php -->
                ...
                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4"
                    ...
                    <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                        <svg class="fill-current h-6 w-6 text-red-500" role="button" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <title>Close</title>
                            <path
                                d="M14.348 5.652a1 1 0 00-1.414 0L10 8.586 7.066 5.652a1 1 0 00-1.414 1.414l2.934 2.934-2.934 2.934a1 1 0 001.414 1.414L10 11.414l2.934 2.934a1 1 0 001.414-1.414l-2.934-2.934 2.934-2.934a1 1 0 000-1.414z" />
                        </svg>
                    </span>
                </div>
            @endif
                ...
                <div class="bg-white shadow-sm rounded-2xl overflow-hidden max-w-xs order-first lg:order-none">
                    <div class="rounded-lg p-8 md:p-8 w-full max-w-xs">
                        <div class="flex flex-col items-center">
                            <!-- Gambar kandidat -->
                            <img class="w-[94px] h-[94px] bg-gray-300 rounded-full mb-4"
                                src="{{ asset('storage/' . $candidate->image) }}" alt="Candidate Image">
                            ...
                            <p class="text-abu-200 font-medium font-poppins">
                                {{ $candidate->kelas->name ?? 'Tidak ada kelas' }}</p>

                            <!-- Nomor Urut Kandidat -->
                            <p class="text-hitam-200 font-semibold font-poppins text-2xl mt-3">
                        ...
                        <div class="mt-4">
                            <form action="{{ route('vote.store') }}" method="POST">
                                ...
                                <button
                                    class="font-montserrat font-semibold w-full h-[42px] bg-ijo-200 hover:bg-ijo-400 transition duration-200 ease-in-out active:bg-ijo-200 focus:outline-none focus:ring focus:ring-ijomuda text-white py-2 rounded-full">
                                    Vote Ketua OSIS
                                </button>
                            </form>
                        </div>
